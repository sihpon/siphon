...
const (
	...
	GreetServiceName = "siphon.v1.GreetService"
)
...
const (
	...
	GreetServiceGreetProcedure = "/siphon.v1.GreetService/Greet"
)

// GreetServiceClient is a client for the siphon.v1.GreetService service.
type GreetServiceClient interface {
	Greet(context.Context, *connect.Request[v1.GreetRequest]) (*connect.Response[v1.GreetResponse], error)
}

// NewGreetServiceClient constructs a client for the siphon.v1.GreetService service. By default, it
...
func NewGreetServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) GreetServiceClient {
	...
	greetServiceMethods := v1.File_siphon_v1_siphon_proto.Services().ByName("GreetService").Methods()
...
// Greet calls siphon.v1.GreetService.Greet.
...
// GreetServiceHandler is an implementation of the siphon.v1.GreetService service.
...
func NewGreetServiceHandler(svc GreetServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/siphon.v1.GreetService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedGreetServiceHandler) Greet(context.Context, *connect.Request[v1.GreetRequest]) (*connect.Response[v1.GreetResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("siphon.v1.GreetService.Greet is not implemented"))
}
