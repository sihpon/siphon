...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "625f0941.my.domain",
	...
	if err = (&controller.SiphonReconciler{
	...
	if err = (&controller.SiphonManagedWorkloadReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "SiphonManagedWorkload")
		os.Exit(1)
	}
